...
func (vec *vector) init(
	...
	case TYPE_BOOLEAN, TYPE_TINYINT, TYPE_SMALLINT, TYPE_INTEGER, TYPE_BIGINT,
		TYPE_UTINYINT, TYPE_USMALLINT, TYPE_UINTEGER, TYPE_UBIGINT, TYPE_FLOAT,
		TYPE_DOUBLE, TYPE_TIMESTAMP, TYPE_DATE, TYPE_TIME, TYPE_INTERVAL,
		TYPE_HUGEINT, TYPE_UHUGEINT, TYPE_VARCHAR, TYPE_BLOB, TYPE_DECIMAL,
		TYPE_TIMESTAMP_S, TYPE_TIMESTAMP_MS, TYPE_TIMESTAMP_NS, TYPE_ENUM,
		TYPE_LIST, TYPE_STRUCT, TYPE_MAP, TYPE_ARRAY, TYPE_UUID, TYPE_UNION,
		TYPE_BIT, TYPE_TIME_TZ, TYPE_TIMESTAMP_TZ, TYPE_BIGNUM, TYPE_SQLNULL,
		TYPE_JSON, TYPE_GEOMETRY, TYPE_LAMBDA, TYPE_VARIANT:
		// These types are supported - continue initialization below
	}
...
func (vec *vector) getTimestamp(
	...
	case TYPE_INVALID, TYPE_BOOLEAN, TYPE_TINYINT, TYPE_SMALLINT, TYPE_INTEGER,
		...
		TYPE_FLOAT, TYPE_DOUBLE, TYPE_DATE, TYPE_TIME, TYPE_INTERVAL, TYPE_HUGEINT,
		TYPE_UHUGEINT, TYPE_VARCHAR, TYPE_BLOB, TYPE_DECIMAL, TYPE_ENUM, TYPE_LIST,
		TYPE_STRUCT, TYPE_MAP, TYPE_ARRAY, TYPE_UUID, TYPE_UNION, TYPE_BIT,
		TYPE_TIME_TZ, TYPE_ANY, TYPE_BIGNUM, TYPE_SQLNULL, TYPE_JSON,
...
func (vec *vector) getDecimal(
	...
	case TYPE_INVALID, TYPE_BOOLEAN, TYPE_TINYINT, TYPE_UTINYINT, TYPE_USMALLINT,
		TYPE_UINTEGER, TYPE_UBIGINT, TYPE_FLOAT, TYPE_DOUBLE, TYPE_TIMESTAMP,
		TYPE_DATE, TYPE_TIME, TYPE_INTERVAL, TYPE_UHUGEINT, TYPE_VARCHAR, TYPE_BLOB,
		...
		TYPE_BIGNUM, TYPE_SQLNULL, TYPE_JSON, TYPE_GEOMETRY, TYPE_LAMBDA, TYPE_VARIANT:
		value = big.NewInt(0)
	}
...
func setDecimal(
	...
	case TYPE_INVALID, TYPE_BOOLEAN, TYPE_TINYINT, TYPE_UTINYINT, TYPE_USMALLINT,
		...
		TYPE_UNION, TYPE_BIT, TYPE_TIME_TZ, TYPE_TIMESTAMP_TZ, TYPE_ANY,
		TYPE_BIGNUM, TYPE_SQLNULL, TYPE_JSON, TYPE_GEOMETRY, TYPE_LAMBDA, TYPE_VARIANT:
		// Unsupported internal type for decimal storage
	}
...
func (vec *vector) getEnum(rowIdx int) string {
	...
	case TYPE_INVALID, TYPE_BOOLEAN, TYPE_TINYINT, TYPE_SMALLINT, TYPE_INTEGER,
		TYPE_BIGINT, TYPE_FLOAT, TYPE_DOUBLE, TYPE_TIMESTAMP, TYPE_DATE, TYPE_TIME,
...
func setEnum(
	...
	case TYPE_INVALID, TYPE_BOOLEAN, TYPE_TINYINT, TYPE_SMALLINT, TYPE_INTEGER,
		...
		TYPE_UNION, TYPE_BIT, TYPE_TIME_TZ, TYPE_TIMESTAMP_TZ, TYPE_ANY,
		TYPE_BIGNUM, TYPE_SQLNULL, TYPE_JSON, TYPE_GEOMETRY, TYPE_LAMBDA, TYPE_VARIANT:
		// Unsupported internal type for enum storage
	}
...
func (vec *vector) initMap(
	...
	case TYPE_INVALID, TYPE_BOOLEAN, TYPE_TINYINT, TYPE_SMALLINT, TYPE_INTEGER,
		...
		TYPE_HUGEINT, TYPE_UHUGEINT, TYPE_VARCHAR, TYPE_BLOB, TYPE_DECIMAL,
		TYPE_TIMESTAMP_S, TYPE_TIMESTAMP_MS, TYPE_TIMESTAMP_NS, TYPE_ENUM, TYPE_UUID,
		TYPE_BIT, TYPE_TIME_TZ, TYPE_TIMESTAMP_TZ, TYPE_ANY, TYPE_BIGNUM, TYPE_SQLNULL,
		TYPE_JSON, TYPE_GEOMETRY, TYPE_LAMBDA, TYPE_VARIANT:
		// These are supported key types
	}
