...
- [x] 1.1 Create savepoint data structures
...
- [x] 1.2 Extend Transaction struct
...
- [x] 2.1 Add parser support for SAVEPOINT
...
- [x] 2.2 Add binder support for SAVEPOINT
...
- [x] 3.1 Add parser support for ROLLBACK TO SAVEPOINT
...
- [x] 4.1 Add parser support for RELEASE SAVEPOINT
...
- [x] 5.1 WAL integration for savepoints
...
- [x] 5.2 TransactionManager integration
