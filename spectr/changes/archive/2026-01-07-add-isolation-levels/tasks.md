...
- [x] 1.1 Add isolation level types to AST
...
- [x] 1.2 Update parser for isolation level syntax
...
- [x] 1.3 Add SET/SHOW for isolation configuration
...
- [x] 1.4 Update transaction manager
...
- [x] 2.1 Create visibility checker interface
...
- [x] 2.2 Implement READ UNCOMMITTED visibility
...
- [x] 2.3 Integrate visibility into table scan
...
- [x] 3.1 Add statement-level timestamps
...
- [x] 3.2 Implement READ COMMITTED visibility
...
- [x] 3.3 Add READ COMMITTED integration tests
...
- [x] 4.1 Add transaction-level snapshots
...
- [x] 4.2 Implement REPEATABLE READ visibility
...
- [x] 4.3 Add REPEATABLE READ integration tests
...
- [x] 5.1 Create conflict detector
...
- [x] 5.2 Implement conflict detection at commit
...
- [x] 5.4 Implement SERIALIZABLE visibility
...
- [x] 5.5 Add SERIALIZABLE integration tests
...
- [x] 6.1 Update executor for isolation levels
...
- [x] 6.2 Update transaction commit/rollback
