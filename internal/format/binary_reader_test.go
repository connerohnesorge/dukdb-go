...
func TestBinaryReaderReadPropertyUint8(
	t *testing.T,
) {
	buf := &bytes.Buffer{}
	writer := NewBinaryWriter(buf)
...
func TestBinaryReaderReadPropertyUint32(
	t *testing.T,
) {
	buf := &bytes.Buffer{}
	writer := NewBinaryWriter(buf)
...
func TestBinaryReaderReadPropertyUint64(
	t *testing.T,
) {
	buf := &bytes.Buffer{}
	writer := NewBinaryWriter(buf)
...
func TestBinaryReaderReadPropertyString(
	t *testing.T,
) {
	tests := []struct {
		name  string
...
func TestBinaryReaderReadPropertyBytes(
	t *testing.T,
) {
	buf := &bytes.Buffer{}
	writer := NewBinaryWriter(buf)
...
func TestBinaryReaderReadPropertyMissing(
	t *testing.T,
) {
	buf := &bytes.Buffer{}
	writer := NewBinaryWriter(buf)
...
func TestBinaryReaderReadListMissing(
	t *testing.T,
) {
	buf := &bytes.Buffer{}
	writer := NewBinaryWriter(buf)
...
func TestBinaryReaderRoundTrip(t *testing.T) {
	...
	err := writer.WriteProperty(
		100,
		uint32(ExtraTypeInfoType_ENUM),
	)
	require.NoError(t, err)
	err = writer.WriteProperty(200, uint64(3))
	require.NoError(t, err)
	err = writer.WriteList(
		201,
		[]string{"RED", "GREEN", "BLUE"},
	)
	require.NoError(t, err)
	err = writer.WritePropertyWithDefault(
		202,
		uint8(10),
		uint8(0),
	)
...
func TestBinaryReaderInvalidDestination(
	t *testing.T,
) {
	t.Run(
	...
	t.Run(
		"non-pointer destination with missing property",
		func(t *testing.T) {
			buf := &bytes.Buffer{}
			writer := NewBinaryWriter(buf)
	...
	t.Run(
		"unsupported type with ReadPropertyWithDefault",
		func(t *testing.T) {
			buf := &bytes.Buffer{}
			writer := NewBinaryWriter(buf)
