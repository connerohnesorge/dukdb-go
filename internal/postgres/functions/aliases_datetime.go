...
func (r *FunctionAliasRegistry) registerDateTimeFuncs() {
	aliases := []*FunctionAlias{
		...
		{PostgreSQLName: "current_timestamp", DuckDBName: funcCurrentTimestamp, Category: DirectAlias,
			MinArgs: 0, MaxArgs: 0, Description: "Returns current date and time"},
		...
		{PostgreSQLName: "transaction_timestamp", DuckDBName: funcCurrentTimestamp, Category: DirectAlias,
			MinArgs: 0, MaxArgs: 0, Description: "Returns timestamp of current transaction"},
		{PostgreSQLName: "statement_timestamp", DuckDBName: funcCurrentTimestamp, Category: DirectAlias,
			MinArgs: 0, MaxArgs: 0, Description: "Returns timestamp of current statement"},
