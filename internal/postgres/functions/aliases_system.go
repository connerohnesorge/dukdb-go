...
func (r *FunctionAliasRegistry) registerSystemIntrospection() {
	aliases := []*FunctionAlias{
		...
		{
			PostgreSQLName: "pg_database_size",
			DuckDBName:     "pg_database_size",
			Category:       SystemFunction,
			MinArgs:        1,
			MaxArgs:        1,
		...
		{
			PostgreSQLName: "pg_relation_size",
			DuckDBName:     "pg_relation_size",
			Category:       SystemFunction,
			MinArgs:        1,
			MaxArgs:        2,
			Description:    "Relation size in bytes",
		},
		{
			PostgreSQLName: "pg_total_relation_size",
			DuckDBName:     "pg_total_relation_size",
			Category:       SystemFunction,
			MinArgs:        1,
			MaxArgs:        1,
...
func (r *FunctionAliasRegistry) registerSystemCatalog() {
	aliases := []*FunctionAlias{
		{
			PostgreSQLName: "pg_get_constraintdef",
			DuckDBName:     "pg_get_constraintdef",
			Category:       SystemFunction,
			MinArgs:        1,
			MaxArgs:        2,
		...
		{
			PostgreSQLName: "pg_get_function_arguments",
			DuckDBName:     "pg_get_function_arguments",
			Category:       SystemFunction,
			MinArgs:        1,
			MaxArgs:        1,
		...
		{
			PostgreSQLName: "pg_get_function_result",
			DuckDBName:     "pg_get_function_result",
			Category:       SystemFunction,
			MinArgs:        1,
			MaxArgs:        1,
		...
		{
			PostgreSQLName: "shobj_description",
			DuckDBName:     "shobj_description",
			Category:       SystemFunction,
			MinArgs:        2,
			MaxArgs:        2,
			Description:    "Shared object comment (returns empty)",
		},
	}
	...
	aliases := []*FunctionAlias{
		{
			...
			Category:       SystemFunction,
			MinArgs:        2,
			MaxArgs:        argsMaxSysThree,
			Description:    "Check table privilege (always true)",
		},
		{
			PostgreSQLName: "has_column_privilege",
			DuckDBName:     "has_column_privilege",
			Category:       SystemFunction,
			MinArgs:        argsMaxSysThree,
			MaxArgs:        argsMaxSysFour,
			Description:    "Check column privilege (always true)",
		},
		{
			PostgreSQLName: "has_schema_privilege",
			DuckDBName:     "has_schema_privilege",
			Category:       SystemFunction,
			MinArgs:        2,
			MaxArgs:        argsMaxSysThree,
			Description:    "Check schema privilege (always true)",
		},
		{
			PostgreSQLName: "has_database_privilege",
			DuckDBName:     "has_database_privilege",
			Category:       SystemFunction,
			MinArgs:        2,
			MaxArgs:        argsMaxSysThree,
			Description:    "Check database privilege (always true)",
		},
		{
			PostgreSQLName: "has_function_privilege",
			DuckDBName:     "has_function_privilege",
			Category:       SystemFunction,
			MinArgs:        2,
			MaxArgs:        argsMaxSysThree,
			Description:    "Check function privilege (always true)",
		},
		{
			PostgreSQLName: "has_sequence_privilege",
			DuckDBName:     "has_sequence_privilege",
			Category:       SystemFunction,
			MinArgs:        2,
			MaxArgs:        argsMaxSysThree,
			Description:    "Check sequence privilege (always true)",
		},
...
func (r *FunctionAliasRegistry) registerSystemSession() {
	aliases := []*FunctionAlias{
		...
		{
			PostgreSQLName: "pg_postmaster_start_time",
			DuckDBName:     "pg_postmaster_start_time",
			Category:       SystemFunction,
			MinArgs:        0,
			MaxArgs:        0,
			...
			MinArgs: 0, MaxArgs: 0, Description: "Show all settings"},
		{
			...
			MinArgs:        0,
			MaxArgs:        0,
			Description:    "Recovery mode check (always false)",
		},
		{
			PostgreSQLName: "pg_is_wal_replay_paused",
			DuckDBName:     "pg_is_wal_replay_paused",
			Category:       SystemFunction,
			MinArgs:        0,
			MaxArgs:        0,
			Description:    "WAL replay paused (always false)",
		},
		{
			PostgreSQLName: "pg_client_encoding",
			DuckDBName:     "pg_client_encoding",
			Category:       SystemFunction,
			MinArgs:        0,
			MaxArgs:        0,
			Description:    "Client encoding (returns UTF8)",
		},
