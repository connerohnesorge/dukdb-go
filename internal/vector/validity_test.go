...
func TestNewValidityMask(t *testing.T) {
	t.Run(
		"creates mask with correct capacity",
		func(t *testing.T) {
	...
	t.Run(
		"initializes all entries as valid",
		func(t *testing.T) {
	...
	t.Run(
		"creates correct number of words",
		func(t *testing.T) {
			// 64 bits per word
...
func TestNewValidityMaskEmpty(t *testing.T) {
	t.Run(
		"creates mask with all entries NULL",
		func(t *testing.T) {
...
func TestValidityMask_SetBits(t *testing.T) {
	t.Run(
		"sets bits from external data",
		func(t *testing.T) {
			mask := NewValidityMaskEmpty(64)
			mask.SetBits(
				[]uint64{0b1010101010101010},
			)
...
func BenchmarkValidityMask_SetValid(
	b *testing.B,
) {
	mask := NewValidityMask(2048)
	b.ResetTimer()
...
func BenchmarkValidityMask_CountValid(
	b *testing.B,
) {
	mask := NewValidityMask(2048)
...
func BenchmarkValidityMask_SetAllValid(
	b *testing.B,
) {
